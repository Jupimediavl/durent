-- Fix notification_type enum and related tables in Supabase
-- Run this script in Supabase SQL Editor

-- 1. Create the notification_type enum
...
-- 3. Create the notification_settings table
...
CREATE INDEX IF NOT EXISTS idx_notifications_createdAt ON public.notifications("createdAt");

-- 5. Create updated_at trigger for notifications table
...
-- 6. Grant necessary permissions (adjust role names as needed)
...
-- 9. Create RLS policies for notification settings
...
-- Success message
SELECT 'Notification enum and tables created successfully!' as result;