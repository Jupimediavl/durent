    ...
    try {
        ...
        if (property.isPublic && property.availabilityStatus === 'AVAILABLE' && address) {
            try {
                ...
                await zoneDigestService_1.zoneDigestService.addPropertyToPendingNotifications(property.id, zoneName);
    ...
    try {
        ...
        if (!wasAvailable && isNowAvailable && updatedProperty.address) {
            try {
                ...
                await zoneDigestService_1.zoneDigestService.addPropertyToPendingNotifications(updatedProperty.id, zoneName);
