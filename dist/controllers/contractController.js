...
exports.extendContract = exports.checkExpiringContracts = exports.getContract = exports.setupContract = void 0;
...
async function generateContractPayments(rentalId, startDate, endDate, monthlyRent, paymentDueDay = 1) {
    const payments = [];
    const now = new Date();
...
const checkExpiringContracts = async (req, res) => {
    try {
...
exports.checkExpiringContracts = checkExpiringContracts;
// Extend contract
