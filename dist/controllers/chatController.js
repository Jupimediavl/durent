...
exports.markAsRead = exports.getConversations = exports.getMessages = exports.sendMessage = void 0;
...
const sendMessage = async (req, res) => {
    try {
        ...
        if (user.userType === 'LANDLORD') {
            ...
            const rental = await prisma_1.prisma.rentalRelationship.findFirst({
                where: {
                    propertyId,
                    tenantId: senderId,
                    status: 'ACTIVE'
        ...
        if (receiver && property) {
            ...
            await notificationService_1.NotificationService.createAndSendNotification(receiverId, 'NEW_MESSAGE', `New message from ${message.sender.name}`, content.substring(0, 100), // Limit message preview to 100 chars
            {
                propertyId,
